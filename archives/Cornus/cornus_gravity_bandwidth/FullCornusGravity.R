...
gravity.2 <- gravity(y="GDist", x=c("PctSky","Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn","roads.mn","pines.var","decid.mn"),
                     group="group", data=graph.data)
