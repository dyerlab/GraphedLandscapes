...
require(nlme)
load("Cornus.data.band1.rda")

graph.data <- cornus.data.band1[ cornus.data.band1$InGraph, ]
...
gravity.2 <- gravity(y="GDist", x=c("DBH","PctSky","Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn","pines.var","decid.mn"),
                     group="group", data=graph.data)
print(gravity.2$formula)
print(lme.sum(gravity.2$GravityModel))

gravity.3 <- gravity(y="GDist", x=c("PctSky","Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn","pines.var","decid.mn"),
                     group="group", data=graph.data)
print(gravity.3$formula)
print(lme.sum(gravity.3$GravityModel))

gravity.4 <- gravity(y="GDist", x=c("Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn","pines.var","decid.mn"),
                     group="group", data=graph.data)
print(gravity.4$formula)
print(lme.sum(gravity.4$GravityModel))

gravity.5 <- gravity(y="GDist", x=c("Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn","decid.mn"),
                     group="group", data=graph.data)
print(gravity.5$formula)
print(lme.sum(gravity.5$GravityModel))

gravity.6 <- gravity(y="GDist", x=c("Clumping","FloralOutput","PDist",
                                    "open.var","cornus.mn"),
                     group="group", data=graph.data)
print(gravity.6$formula)
print(lme.sum(gravity.6$GravityModel))

gravity.7 <- gravity(y="GDist", x=c("Clumping","FloralOutput","PDist",
                                    "open.var"),
                     group="group", data=graph.data)
print(gravity.7$formula)
print(lme.sum(gravity.7$GravityModel))

gravity.8 <- gravity(y="GDist", x=c("Clumping","FloralOutput","PDist"),
                     group="group", data=graph.data)
print(gravity.8$formula)
print(lme.sum(gravity.8$GravityModel))

gravity.9 <- gravity(y="GDist", x=c("Clumping","FloralOutput"),
                     group="group", data=graph.data)
print(gravity.9$formula)
print(lme.sum(gravity.9$GravityModel))

gravity.10 <- gravity(y="GDist", x=c("FloralOutput"),
                     group="group", data=graph.data)
...
#AIC using AIC()
AIC(gravity.1$GravityModel)
AIC(gravity.2$GravityModel)
AIC(gravity.3$GravityModel)
AIC(gravity.4$GravityModel)
AIC(gravity.5$GravityModel)
AIC(gravity.6$GravityModel)
AIC(gravity.7$GravityModel)
AIC(gravity.8$GravityModel)
AIC(gravity.9$GravityModel)
AIC(gravity.10$GravityModel)

#r2
find.r2(gravity.1$GravityModel)
find.r2(gravity.2$GravityModel)
find.r2(gravity.3$GravityModel)
find.r2(gravity.4$GravityModel)
find.r2(gravity.5$GravityModel)
find.r2(gravity.6$GravityModel)
find.r2(gravity.7$GravityModel)
find.r2(gravity.8$GravityModel)
find.r2(gravity.9$GravityModel)
find.r2(gravity.10$GravityModel)